...
int fps_def_cnt[4] = { 14596,14596,80071,113150 } ; // New Encoder as per Abhay B email date : 25/04/2019
...
void AppendAdd(unsigned char *buff)
{
   ...
   extern int resp_fpsfd;
    ...
    //sleep(1); 
     usleep(500000);
    ret=read(resp_fpsfd,rbuff.Msg,200);
