...
#define SERVER_ADDR    "192.168.70.21"  // Server for LAB testing
...
char *fpsfifo,*respfps;
int fps_fd,resp_fd;      /* FIF0 File Descriptor for writing FECB command, Which can be read by USb-RS485 program */ 
