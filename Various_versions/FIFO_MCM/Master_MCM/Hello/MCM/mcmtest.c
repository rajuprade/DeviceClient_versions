...
#include <pthread.h>
#include<fcntl.h>
#include "/home/raj/Device_Client/FIFO_MCM/Master_MCM/Hello/ftd2xx.h" 
...
//  fprintf(stdout,"%s %s",mask0, mask1);
  ...
  printf("#################################################################\n");
    ...
    buff[10] = Arg[1];
    buff[11] = Arg[2];
    buff[12] = (unsigned)Arg[3]; 
    buff[13] = Arg[4];
    buff[14] = Arg[5];
    buff[15] = Arg[6];
    buff[16] = (unsigned)Arg[7];
...
int set_newlo(char *buf_ptr0, int lo1, int lo2 )
{
  ...
  //  char masksp[6][8] = {"0080","8080","1000","9000","600D","E01D"};
