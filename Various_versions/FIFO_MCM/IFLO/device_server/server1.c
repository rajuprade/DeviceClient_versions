    ...
    // printf("3 : set ramp down count\n");
     printf("Enter the Operation Code :");
       ...
       tstamp = malloc(25);
        ...
        strcpy(c1->cmdelem.subsysid,"iflo");
            ...
            switch(i)
             {
                ...
                case 0 : strcpy(c1->cmdelem.cmd_id,"500");
                         strcpy(c1->cmdelem.cmd_name,"set_lo");
                         c1->cmd_data.numpkt=2;

                       strcpy(c1->cmd_data.prmname[0],"lo1");
                       strcpy(c1->cmd_data.prmname[1],"lo2");
                       scanf("%s %s",LO1,LO2);
                       
                       strcpy(c1->cmd_data.prmvalue[0],LO1);
                       strcpy(c1->cmd_data.prmvalue[1],LO2);
                       
                        break;

                case 1 : strcpy(c1->cmdelem.cmd_id,"501");
                         strcpy(c1->cmdelem.cmd_name,"set_if");
