...
void front_end(parseCMSCmd *c1)
{
     ...
     printf("Enter the Operation Code : 0 : Null, 1 : SETRFSYS, 3 : Domon,4 : URSETRFSYS,5:WALSHPATERN,6:WALSHFREQ,7:NOISEFREQ,8:SETRFNOISE,9: FE SEL\n");
      scanf("%d",&i); 
       // i=0;
        char *tstamp;
       tstamp = malloc(25);
            ...
            switch(i)
             {
                ...
                case 1 : strcpy(c1->cmdelem.cmd_id,"2");
                       ...
                       strcpy(c1->cmd_data.prmvalue[6],"2");
                  ...
                  case 4: strcpy(c1->cmdelem.cmd_id,"15");
                       ...
                       strcpy(c1->cmd_data.prmname[9],"rfcm_sw");
                       strcpy(c1->cmd_data.prmname[10],"ngset");
                       strcpy(c1->cmd_data.prmname[11],"walshpattern");
                       strcpy(c1->cmd_data.prmname[12],"walshfreq");
                       strcpy(c1->cmd_data.prmname[13],"noisefreq");
                       printf("Enter the Channel 1 & Channel 2 Frequency Band\n");
                       scanf("%s %s",FB1,FB2);
                       ...
                       strcpy(c1->cmd_data.prmvalue[10],"0");
                        strcpy(c1->cmd_data.prmvalue[11],"0");
                         strcpy(c1->cmd_data.prmvalue[12],"0");
                            strcpy(c1->cmd_data.prmvalue[13],"0"); 
                        break;
                   case 5:  strcpy(c1->cmdelem.cmd_id,"213");
                            strcpy(c1->cmdelem.cmd_name,"walshpatern");
                             c1->cmd_data.numpkt=1;
                             strcpy(c1->cmd_data.prmname[0],"walshpattern");
                              strcpy(c1->cmd_data.prmvalue[0],"4"); 
                   case 6:  strcpy(c1->cmdelem.cmd_id,"221");
                            strcpy(c1->cmdelem.cmd_name,"walshfreq");
                             c1->cmd_data.numpkt=1;
                             strcpy(c1->cmd_data.prmname[0],"walshfreq");
                              strcpy(c1->cmd_data.prmvalue[0],"2"); 
                            break;
                   case 7:  strcpy(c1->cmdelem.cmd_id,"222");
                            strcpy(c1->cmdelem.cmd_name,"noisefreq");
                             c1->cmd_data.numpkt=1;
                             strcpy(c1->cmd_data.prmname[0],"noisefreq");
                              strcpy(c1->cmd_data.prmvalue[0],"3"); 
                              break;
                   case 8:  strcpy(c1->cmdelem.cmd_id,"223");
                            strcpy(c1->cmdelem.cmd_name,"setrfnoise");
                             c1->cmd_data.numpkt=1;
                             strcpy(c1->cmd_data.prmname[0],"fe_ngycle");
                              strcpy(c1->cmd_data.prmvalue[0],"100"); break;
                   case 9:  strcpy(c1->cmdelem.cmd_id,"216");
                            strcpy(c1->cmdelem.cmd_name,"rfcm_sw");
                             c1->cmd_data.numpkt=1;
                             strcpy(c1->cmd_data.prmname[0],"rfcm_sw");
                              strcpy(c1->cmd_data.prmvalue[0],"1"); break;
